...
public class SecondSearchActivityRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private static final String TAG = SecondSearchActivityRecyclerViewAdapter.class.getSimpleName();
    private Context mContext;
    private OnItemClickListener mOnItemClickListener;
    private SecondSearchBean itemsData;


    public SecondSearchActivityRecyclerViewAdapter(Context mContext, SecondSearchBean itemsData) {
        super();
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof ItemViewHolder) {
            ...
            mItemViewHolder.tv.setText(itemsData.getBuildlist().get(position).getName());
        }
